...
// in kagi_news_app/test/features/bookmarks/views/bookmark_screen_test.dart.
...
/// A class which mocks [BookmarkViewmodel].
///
/// See the documentation for Mockito's code generation for more information.
class MockBookmarkViewmodel extends _i1.Mock implements _i2.BookmarkViewmodel {
  MockBookmarkViewmodel() {
  ...
  @override
  void getAllBookmarks() => super.noSuchMethod(
        Invocation.method(
          #getAllBookmarks,
          [],
        ),
  ...
  @override
  _i3.Future<void> clearAllBookmarks() => (super.noSuchMethod(
        Invocation.method(
          #clearAllBookmarks,
          [],
        ),
